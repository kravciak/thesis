...
\lstset{morekeywords={select, where, order, by, limit, and, or, from, asc, desc}}
...
%\include{chapters/0_notes}

\include{chapters/10_uvod}
\include{chapters/20_pojmy}
\include{chapters/30_technologie}
\include{chapters/40_implementacia}
\include{chapters/50_instalacia}
\include{chapters/60_zaver}

\input{chapters/0_skratky}
